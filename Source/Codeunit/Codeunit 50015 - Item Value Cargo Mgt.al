codeunit 50015 "Item Value Cargo Mgt"
{
    ...
    begin
        ...
        if JiramaForeCast.FindSet then
            repeat
                ...
                if JiramaForeCastLine.FindSet then
                    repeat
    ...
    begin
        ...
        if ((CargoEntry."Entry Type" <> CargoEntry."Entry Type"::Sale)
          ...
          and (CargoEntry."Entry Type" <> CargoEntry."Entry Type"::"Positive Adjmt.")) then
            exit;
