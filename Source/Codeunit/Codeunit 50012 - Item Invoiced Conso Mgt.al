codeunit 50012 "Item Invoiced Conso Mgt"
{
    ...
    local procedure GetCoutSortieStock(): decimal
    var
    begin
        //Retrouver la sortie article et prendre son cout
    ...
    begin
        ...
        if ItemAdj.Get(ItemAdj."Document Type"::"Invoiced Consumption", SalesHeader."Created By Doc No.") then begin
