page 50307 "Partially Received Purch Order"
{
    Caption = 'Partially Received Purch Order List';
        ...
        area(processing)
        {
            group(General)
            {
                ...
                action(Print)
                {
                    ...
                    begin
                        //****************************
                        if Rec."Purchase Type" = Rec."Purchase Type"::AchatAutre then
