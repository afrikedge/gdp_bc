page 50200 "Cash Transfer Journal TRESO"
{
    // JN001 231019 Creation de cette feuille pour initialisation Virement par les trésoriers

    AutoSplitKey = true;
    Caption = 'TRESO Cash Receipt Journal';
    ...
    begin
        ...
        Rec."CC Document Type" := Rec."CC Document Type"::Virement;
        //***************************************************
        //***************************************************
    end;
    ...
    begin
        //******************************************
        if Rec."CC Document Type" <> Rec."CC Document Type"::Virement then
            Error(TextErr01);
        //******************************************
    end;
}
