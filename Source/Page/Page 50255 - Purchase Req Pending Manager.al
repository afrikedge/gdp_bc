page 50255 "Purchase Req Pending Manager"
{
    Caption = 'Purch. Requisition List - Pending Approval Manager';
    ...
    begin
        ...
        Rec.FilterGroup(2);
        Rec.SetFilter(Rec."Create By", ReqMgt.GetFiltreDemandesManager(UserId));
        Rec.FilterGroup(0);
    end;
