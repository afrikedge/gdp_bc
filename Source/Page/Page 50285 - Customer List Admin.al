    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Afk Other Legal Status"; Rec."Afk Other Legal Status")
                {
                }
                ...
                field("Afk Warranty Caution"; Rec."Afk Warranty Caution")
                {
                }
                field("Afk Warranty Status"; Rec."Afk Warranty Status")
                {
                }
                field("Afk Warranty Value"; Rec."Afk Warranty Value")
                {
                }
                field("Afk Warranty Validity"; Rec."Afk Warranty Validity")
                {
                }
                field("Afk Warranty Due Date"; Rec."Afk Warranty Due Date")
                {
                }
                field("Afk Warranty Object"; Rec."Afk Warranty Object")
                {
                }
