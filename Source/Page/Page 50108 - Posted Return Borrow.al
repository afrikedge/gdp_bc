page 50108 "Posted Return Borrow"
{
    Caption = 'Item Return Borrow';
    Editable = false;
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Lines; "Posted Return Borrow Subform")
            {
                Caption = 'Lines';
    ...
    actions
    {
        area(navigation)
        {
            ...
            action(FactureVente)
            {
                ...
                begin
                    SalesH.Reset;
                    SalesH.SetRange(SalesH."Created By Doc Type", SalesH."Created By Doc Type"::Borrow);
                    ...
                    if SalesH.FindFirst then begin
                        ...
                        PostedSalesH.Reset;
                        PostedSalesH.SetRange(PostedSalesH."Created By Doc Type", PostedSalesH."Created By Doc Type"::Borrow);
            ...
            action(FactureAchat)
            {
                ...
                begin
                    ...
                    if PurchH.FindFirst then begin
                        ...
                        PostedPurchH.Reset;
                        PostedPurchH.SetRange("Created By Doc Type", PostedPurchH."Created By Doc Type"::Borrow);
