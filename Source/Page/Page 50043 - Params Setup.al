page 50043 "Params Setup"
{
    CardPageID = "AddOn Setup Card";
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("JIRAMA Ambohimanambola Loc"; Rec."JIRAMA Ambohimanambola Loc")
                {
                }
                field("Ambohimanambola Fees Location"; Rec."Ambohimanambola Fees Location")
                {
                }
                field("Prov Transfert Amba Region"; Rec."Prov Transfert Amba Region")
                {
                }
                field("Prov Transfert Amba Project"; Rec."Prov Transfert Amba Project")
                {
                }
                ...
                field("Remove MFiles Num Check"; Rec."Remove MFiles Num Check")
                {
                }
                field("CAP CreditNote Gerant Prepaid"; Rec."CAP CreditNote Gerant Prepaid")
                {
                }
                field("CAP DebitNote Gerant Prepaid"; Rec."CAP DebitNote Gerant Prepaid")
                {
                }
                field("CAP VAT Group NDNC Gerant"; Rec."CAP VAT Group NDNC Gerant")
                {
                }
                field("CAP CreditNote Gerant Postpaid"; Rec."CAP CreditNote Gerant Postpaid")
                {
                }
                field("CAP DebitNote Gerant Postpaid"; Rec."CAP DebitNote Gerant Postpaid")
                {
                }
                field("CAP CreditNote Gerant GPRO"; Rec."CAP CreditNote Gerant GPRO")
                {
                }
                field("CAP DebitNote Gerant GPRO"; Rec."CAP DebitNote Gerant GPRO")
                {
                }
                field(GOItem; Rec.GOItem)
                {
                }
                field("CRM Web Service Adress"; Rec."CRM Web Service Adress")
                {
                }
                field("CRM DB Server"; Rec."CRM DB Server")
                {
                }
                field("CRM DB Name"; Rec."CRM DB Name")
                {
                }
                field("CRM DB User"; Rec."CRM DB User")
                {
                }
                field("CRM DB Password"; Rec."CRM DB Password")
                {
                }
                field("Print Directory Setup"; Rec."Print Directory Setup")
                {
                }
                field("Dispaching Unit Code"; Rec."Dispaching Unit Code")
                {
                }
                field("CRM Interface Program Path"; Rec."CRM Interface Program Path")
                {
                }
                ...
                field(BankTransfCertificatIssuerName; Rec.BankTransfCertificatIssuerName)
                {
                }
    ...
    actions
    {
        area(processing)
        {
            ...
            {
                Caption = 'Maj Bls';
                RunObject = Report "Maj BLs";
                Visible = false;
            }
            action("Mise a jour TVA")
            {
                Caption = 'Mise a jour TVA';
                Image = UpdateDescription;
                Promoted = true;
                PromotedCategory = Process;
                RunObject = Report UpdateSO_NewVAT;
            }
            action("Suppr Commandes Achat")
            {
                Caption = 'Suppr Commandes Achat';
                Image = DeleteAllBreakpoints;
                Promoted = true;
                PromotedCategory = Process;
                RunObject = XMLport "Archive PO";
            }
            action("Suppr Commandes Achat - Force")
            {
                Caption = 'Suppr Commandes Achat - Force';
                Image = DeleteAllBreakpoints;
                Promoted = true;
                PromotedCategory = Process;
                RunObject = XMLport "Archive Cdes Achat Force";
            }
            action("Suppr Commandes vente - Force")
            {
                Caption = 'Suppr Commandes vente - Force';
                Image = DeleteAllBreakpoints;
                Promoted = true;
                PromotedCategory = Process;
