page 50304 "MFiles Invoice List - Creation"
{
    Caption = 'Liste des factures fournisseurs à intégrer (MFiles)';
    CardPageID = "MFiles Invoice - In Progress";
    Editable = false;
    PageType = List;
    SourceTable = tblFacture;
    SourceTableView = WHERE(Statut = CONST(Created),
                            FactureDirecte = CONST(true));
