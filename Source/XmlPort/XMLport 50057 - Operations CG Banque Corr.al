xmlport 50057 "Operations CG Banque Corr"
{
    Caption = 'Import Ecr bancaires Correction';
    Direction = Import;
    FieldDelimiter = '<None>';
    FieldSeparator = '<TAB>';
    Format = VariableText;
            ...
            tableelement("Import Data";"Import Data")
            {
                ...
                begin
                    ...
                    Round(BesoinNo / NbreTotalLignes * 10000,1));
                      ...
                      GenJrnLine."Document No." := 'CMIGBA'+Format(BesoinNo);
                      GenJrnLine."External Document No." := CopyStr("Import Data".Description2,1,35);
