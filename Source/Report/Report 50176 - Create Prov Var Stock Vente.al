report 50176 "Create Prov Var Stock Vente"
{
        ...
        dataitem("Sales Header";"Sales Header")
        {
            ...
            begin
                   ...
                   if Cust.Get("Sales Header"."Sell-to Customer No.") then
                     CreateEntry := GLMgt.TraiterProvisionCdeVenteVarStock_CdeNormale("Sales Header",ModeleFeuille,NomFeuille,PostingDate,LastDocNo,LineNum,
                      DateDeb,DateFin);
