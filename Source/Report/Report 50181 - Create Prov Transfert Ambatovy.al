report 50181 "Create Prov Transfert Ambatovy"
{
    Caption = 'Provisions transfert vers Ambatovy';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("Posted Adjustment Header";"Posted Adjustment Header")
        {
            ...
            dataitem("Posted Adjustment Line";"Posted Adjustment Line")
            {
                ...
                begin
                    ProvisionsItemMgt.TraiterProvisionFraisTransfertToAmbatovy("Posted Adjustment Header",
