report 50054 "Check BFV"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Check BFV.rdlc';
    Caption = 'Check';
            ...
            dataitem(CheckPages;"Integer")
            {
                ...
                dataitem(PrintCheck;"Integer")
                {
                    ...
                    begin
                        ...
                        DescriptLine1:=CopyStr(DescriptionLine[1],1,65);
                        if StrLen(DescriptionLine[1]) > 65 then
                          DescriptLine2:=CopyStr(DescriptionLine[1],66);
                    end;
                }
    ...
    labels
    {
        ...
        Linenum = 'Numéro';
        Tot = 'Total';
        Titre = 'LETTRE DE PAIEMENT par CHEQUE n°';
        ...
        MessTraite = 'Veuillez accuser réception du chèque n°';
    }
