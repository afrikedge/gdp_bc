// report 50025 "ND/NC MT Before Post"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Source/Report/Layout/NDNC MT Before Post.rdlc';
...
//                 {
//                 }
//                 column(PostDate;Format("MoneyTech Import"."Posting Date"))
//                 {
//                 }
...
//                     begin
//                         if QJrIM.Read then
//                           CodeJournaux:='JRNL '+QJrIM.TransmissionNo+ ' DU '+Format("MoneyTech Import"."Starting Date");
//                     end;
...
//                     QStationMoneyT.SetFilter(Document_No,"MoneyTech Import"."No.");
//                     QStationMoneyT.Open ;
//                     Counter2:=0;
//                 end;
//             }
...
//             trigger OnAfterGetRecord()
//             begin
//                 QStationMoneyT1.SetFilter(Document_No,"MoneyTech Import"."No.");
...
//         Num: Text[20];
//         QStationMoneyT: Query "Regroup Station Im Moneytech";
//         CondPaiem: Record "Payment Terms";
//         Counter: Integer;
//         QStationMoneyT1: Query "Regroup Station Im Moneytech";
//         MTImpLine: Record "MoneyTech Import Line";
//         CodeJournaux: Text[300];
//         Text011: Label 'Code Journaux';
//         QJrIM: Query "Regroup Station Jr IM";
//         Counter2: Integer;
//         QJrIM1: Query "Regroup Station Jr IM";
