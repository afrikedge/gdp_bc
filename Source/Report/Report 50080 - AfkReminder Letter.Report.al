report 50080 "Afk Reminder Letter"
{
    ...
    dataset
    {
        dataitem("Issued Reminder Header"; "Issued Reminder Header")
        {
            ...
            RequestFilterHeading = 'Reminder Letter';
            ...
            column(ObjTitleLbl; ObjTitleLbl)
            {
            }
            column(SalutationLbl; SalutationLbl)
            {
            }
            column(Para1Lbl; Para1Lbl)
            {
            }
            column(Para2Lbl; Para2Lbl)
            {
            }
            column(Para3Lbl; Para3Lbl)
            {
            }
            column(Para4Lbl; Para4Lbl)
            {
            }
            column(Para5Lbl; Para5Lbl)
            {
            }
            column(SalesManagerLbl; SalesManagerLbl)
            {
            }
            column(ManagerNameLbl; ManagerNameLbl)
            {
            }
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(CustNo; "Issued Reminder Header"."Customer No.")
                {
                }
                column(CustName; "Issued Reminder Header".Name)
                {
                }
                column(CustAddress; "Issued Reminder Header".Address)
                {
                }
                column(CustPostCode; "Issued Reminder Header"."Post Code")
                {
                }
                column(CustCity; "Issued Reminder Header".City)
                {
                }
                ...
                dataitem(LetterText; "Integer")
                {
                    ...
                    begin
                        ...
                        AmtDueTxt := '';
                        BodyTxt := '';
                        GreetingTxt := GreetingLbl;         // ReminderEmailText.GetDefaultGreetingLbl(); 
                        ClosingTxt := ClosingLbl;           // ReminderEmailText.GetDefaultClosingLbl();
                        DescriptionTxt := DescriptionLbl;   // ReminderEmailText.GetDescriptionLbl();
                        ...
                        if GetEmailTextInStream(EmailTextInStream, "Issued Reminder Header") then begin
                            ...
                            BodyTxt := BodyLbl;                 // ReminderEmailText.GetBodyLbl();
                        // end;
    ...
    var
        ...
        DateLbl: Label 'Date :';
        ObjectLbl: Label 'Objet :';
        ObjTitleLbl: Label 'Première Relance de règlement';
        SalutationLbl: Label 'Cher(e) Client(e),';
        Para1Lbl: Label 'Nous vous contactons au sujet des factures figurant sur le relevé joint à ce courriel.';
        Para2Lbl: Label 'Sauf erreur ou omission de notre part, nous constatons qu''à ce jour, ces factures demeurent impayées dans nos registres.';
        Para4Lbl: Label 'Si vous rencontrez des difficultés ou souhaitez échanger à ce sujet, nous vous invitons à contacter votre responsable commercial habituel.';
        Para5Lbl: Label 'Veuillez agréer, Monsieur/Madame, l''expression de nos meilleures salutations.';
        SalesManagerLbl: Label 'Le Directeur Commercial,';
        ManagerNameLbl: Label 'Sedera RAVELOSON';
        Para3Lbl: Label 'Si votre règlement a été effectué entre-temps, nous vous prions de bien vouloir considérer ce courrier comme nul et vous présentons nos excuses pour cette relance. Dans le cas contraire, nous vous saurions gré de procéder au règlement dans les meilleurs délais afin de régulariser votre situation.';
