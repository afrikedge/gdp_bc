report 50015 "Order Autres Achat"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(DocNo_PurchLine; "Purchase Line"."Document No.")
                        {
                        }
            ...
            begin
                ...
                if "Currency Code" = '' then begin
                    ...
                    DevAmount := StrSubstNo(DevAmountCaption, GLSetup."LCY Code");
                end else begin
                    TotalText := StrSubstNo(Text001, "Currency Code");
                    TotalInclVATText := StrSubstNo(Text002, "Currency Code");
                    TotalExclVATText := StrSubstNo(Text006, "Currency Code");
                    DevAmount := StrSubstNo(DevAmountCaption, "Currency Code");
                end;
                ...
                DateCde := "Purchase Header"."Order Date";
                if "Purchase Header"."Order Date" = 0D then
                    DateCde := "Purchase Header"."Document Date";
    ...
    labels
    {
        ...
        PrepareBy = 'Chef de Département';
        VerifyBy = 'Validé par';
        AutoriseBy = 'Autorisé par';
        NbrFact = 'Important : Les factures doivent nous parvenir en 1 seul exemplaire avec les détails fiscaux';
        Text10 = 'Siège Social';
        Dept = 'Département :';
