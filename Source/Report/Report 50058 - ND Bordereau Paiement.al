report 50058 "ND Bordereau Paiement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ND Bordereau Paiement.rdlc';
    Caption = 'Debit Note';
    ...
    dataset
    {
        dataitem("Payment Line"; "Payment Line")
        {
            ...
            column(CheckNumber; PaymentHeader."Check Number")
            {
            }
            ...
            begin
                ...
                if "Payment Line"."Document No." in ['CHK000001' .. 'CHK999999'] then begin
                    if "Payment Line"."Line No." = 10000 then
                        Descript := 'Redebit du client chèque N° ' + PaymentHeader."Check Number"
                    else
                        Descript := 'Frais impayés chèque N° ' + PaymentHeader."Check Number";
                end else if "Payment Line"."Document No." in ['TRC000001' .. 'TRC999999'] then begin
                    if "Payment Line"."Line No." = 10000 then
                        Descript := 'Redebit du client traite N° ' + PaymentHeader."Check Number"
                    else
                        Descript := 'Frais impayés traite N° ' + PaymentHeader."Check Number";
                end;
