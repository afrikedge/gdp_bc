report 50048 "Sales  Invoice ND"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(UnitofMeasure_SalesInvLine; "Unit of Measure Code")
                        {
                        }
                        ...
                        column(VATAmtText_SalesInvLine; VATAmountLine."VAT %")
                        {
                        }
            ...
            begin
                ...
                SalesInvLineLocation.SetRange("Document No.", "No.");
                SalesInvLineLocation.FindFirst;
                if Location.Get(SalesInvLineLocation."Location Code") then
    ...
    var
        ...
        Quantity_SalesInvLineCaption: Label 'QUANTITE ou NOMBRE';
        NbTLet: Report Check;
