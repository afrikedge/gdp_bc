report 50084 "Bon de sortie Feuille reclass2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Bon de sortie Feuille reclass2.rdlc';
    ...
    dataset
    {
        dataitem("Item Journal Batch";"Item Journal Batch")
        {
            ...
            dataitem("Item Journal Line";"Item Journal Line")
            {
                ...
                column(Observations_ItemJournalLine;Observations)
                {
                }
    ...
    labels
    {
        ...
        LblObbservations = 'Renseignement d''observation';
        LblControleurExp = 'Contrôleur Expédition *';
        LblTransporteur = 'Transporteur *';
        LblReceptionnaire = 'Receptionnaire *';
    }
