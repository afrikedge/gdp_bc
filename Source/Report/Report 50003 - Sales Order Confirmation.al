report 50003 "Sales Order Confirmation"
{
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(No2_SalesLineCaption; No2_SalesLineCaption)
                        {
                        }
    ...
    labels
    {
        RecpCom = 'Accusé Réception Commande';
        Text1 = 'Date de réception commande';
        Text2 = 'Date de livraison souhaitée :';
    ...
    var
        ...
        No2_SalesLineCaption: Label 'Produit';
        MontLetter: Label 'Arrêté le présent bon de commande à la somme de  :     ';
        InvDiscAmtCaptionLbl: Label 'Remise';
        NbTLet: Report Check;
