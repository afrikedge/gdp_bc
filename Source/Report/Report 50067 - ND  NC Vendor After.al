report 50067 "ND / NC Vendor After"
{
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            column(CustomerNo; "Vendor Ledger Entry"."Vendor No.")
            {
            }
            ...
            column(BalVATBaseAmount_GenJournalLine; MontantTTC - MontantTVA)
            {
            }
            ...
            begin
                ...
                */
                ...
                MontantTTC := Abs("Vendor Ledger Entry".Amount);
    ...
    local procedure CalcMontantTVA(VendLedgEntry: Record "Vendor Ledger Entry") Rep: Decimal
    var
