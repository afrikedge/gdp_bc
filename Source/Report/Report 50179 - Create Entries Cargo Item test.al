report 50179 "Create Entries Cargo Item test"
{
    ...
    dataset
    {
        dataitem("Item Cargo Entry"; "Item Cargo Entry")
        {
            ...
            begin
                ...
                CreateEntry := CargoMgt.TraiterComptaStockCargo_TEST("Item Cargo Entry", ModeleFeuille, NomFeuille, PostingDate, LastDocNo, DateDeb, DateFin, LineNum);
