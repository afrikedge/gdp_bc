/// <summary>
/// Report Sales Invoice Soutage (ID 50192).
/// </summary>
report 50192 "Sales Invoice Soutage"
{
    Caption = 'Sales Invoice - Soutage';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(AgenceCode; AgenceCode)
            {
            }
            column(RIBKey; RIBKey)
            {
            }
            ...
            column(LoadingDateLbl; LoadingDateLbl)
            {
            }
            ...
            column(PriceUnitLbl; PriceUnitLbl)
            {
            }
            column(AmountLbl; AmountLbl)
            {
            }
            column(NomenclatureLbl; NomenclatureLbl)
            {
            }
            column(TotalAmtLbl; TotalAmtLbl)
            {
            }
            column(BunkerReceiptNbLbl; BunkerReceiptNbLbl)
            {
            }
            column(InvoiceArrestedLbl; InvoiceArrestedLbl)
            {
            }
            column(PaymentDeadlineLbl; PaymentDeadlineLbl)
            {
            }
            column(BanKAccDetailsLbl; BanKAccDetailsLbl)
            {
            }
            ...
            column(BankCodeLbl; BankCodeLbl)
            {
            }
            column(DeskCodeLbl; DeskCodeLbl)
            {
            }
            column(AccountNumberLbl; AccountNumberLbl)
            {
            }
            column(RIBLbl; RIBLbl)
            {
            }
            column(KeyLbl; KeyLbl)
            {
            }
            ...
            begin
                ...
                if CompanyBankAccount.Get(CompanyInfo."Default Bank Account No.") then begin
                    ...
                    BankAddress := CompanyBankAccount.Address + ' - ' + CompanyBankAccount.City + ' - ' + CompanyBankAccount."Post Code";
                    BankBranch := CompanyBankAccount."Bank Branch No.";
                    AgenceCode := CompanyBankAccount."Agency Code";
                    RIBKey := CompanyBankAccount."RIB Key";
    ...
    var
        ...
        Amount_InWords: Text;
        FormattedTotalHT: Text;
        FormattedTotalVAT: Text;
        FormattedTotalTTC: Text;
        FormattedTotalHT_LCYText: Text;
        ...
        JobNo2Lbl: Label 'Project No.';
        JobTaskNo2Lbl: Label 'Project Task No.';
        ...
        LoadingDateLbl: Label 'Loading date';
        DesignationLbl: Label 'Designation';
        ProductLbl: Label 'product';
        QuantityLbl: Label 'QUANTITY';
        ProductUnitLbl: Label 'm³';
        UnitPriceLbl: Label 'Unit Price';
        PriceUnitLbl: Label '$/m³';
        AmountLbl: Label 'Amount';
        NomenclatureLbl: Label 'Nomenclature :';
        TotalAmtLbl: Label 'TOTAL';
        BunkerReceiptNbLbl: Label 'BUNKER RECEIPT N°';
        InvoiceArrestedLbl: Label 'Invoice arrested at the sum of :';
        PaymentDeadlineLbl: Label 'PAYMENT DEADLINE :';
        BanKAccDetailsLbl: Label 'Bank Account details :';
        CompanyLbl: Label 'Company :';
        BankLbl: Label 'Bank :';
        BankCodeLbl: Label 'Bank Code :';
        DeskCodeLbl: Label 'Desk Code :';
        AccountNumberLbl: Label 'Account Number :';
        RIBLbl: Label 'RIB Key :';
        KeyLbl: Label 'Key :';
    ...
    local procedure GetJobTaskDescription(JobNoD: Code[20]; JobTaskNoD: Code[20]): Text[100]
    var
        JobTask: Record "Job Task";
    begin
        JobTask.SetRange("Job No.", JobNoD);
        JobTask.SetRange("Job Task No.", JobTaskNoD);
