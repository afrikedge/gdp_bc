report 50045 "Check BOA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Check BOA.rdlc';
    Caption = 'Check';
            ...
            dataitem(CheckPages;"Integer")
            {
                ...
                dataitem(PrintCheck;"Integer")
                {
                    ...
                    begin
                        ...
                        DescriptLine1:=CopyStr(DescriptionLine[1],1,70);
                        if StrLen(DescriptionLine[1]) > 70 then
                          DescriptLine2:=CopyStr(DescriptionLine[1],71);
                    end;
                }
